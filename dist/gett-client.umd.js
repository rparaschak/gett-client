(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('os'), require('tty'), require('util'), require('http'), require('https'), require('assert'), require('stream'), require('url'), require('zlib')) :
    typeof define === 'function' && define.amd ? define(['exports', 'os', 'tty', 'util', 'http', 'https', 'assert', 'stream', 'url', 'zlib'], factory) :
    (factory((global.gettClient = {}),global.os,global.tty,global.util,global.http,global.https,global.assert,global.stream,global.url,global.zlib));
}(this, (function (exports,os,tty,util,http,https,assert,stream,url,zlib) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var _spec = "axios";
    var _where = "/Users/rparaschak/workspace/gett-client-ts";
    var author = {
    	name: "Matt Zabriskie"
    };
    var browser$1 = {
    ...
    var GettApiEndpoints;
    (function (GettApiEndpoints) {
        GettApiEndpoints["LOGIN"] = "/1/users/login";
        GettApiEndpoints["GET_SHARES"] = "/1/shares";
    })(GettApiEndpoints || (GettApiEndpoints = {}));

    var GettClient = /** @class */ (function () {
        function GettClient() {
            this.email = '';
            this.accessToken = '';
            this.refreshToken = '';
        ...
        GettClient.prototype.login = function (email, password) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            this.email = email;
                            return [4 /*yield*/, this.axios.post(GettApiEndpoints.LOGIN, {
                                    email: email,
                                    password: password
                                })];
                        case 1:
        ...
        GettClient.prototype.getShares = function () {
            return __awaiter(this, void 0, void 0, function () {
                var shares;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.axios
                                    .get(GettApiEndpoints.GET_SHARES + "?" + this.accessTokenQueryString)];
                        case 1:
                            shares = _a.sent();
                            return [2 /*return*/, shares.data];
                    }
                });
            });
        };
        Object.defineProperty(GettClient.prototype, "accessTokenQueryString", {
            get: function () {
    ...
    exports.GettClient = GettClient;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=gett-client.umd.js.map
